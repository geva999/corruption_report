    ...
    if (isset($id)) {
      ...
      if ($project['Project']['projectreportstate'] == 2) {
        ...
        if ($this->Project->saveField('projectreportstate', 3, true)) {
          ...
          $this->data['Report']['p09text1'] = 'Согласно п. 7) статьи 21 Закона о нормативных правовых актах Р. Казахстан, к проекту должны прилагаться финансово-экономические затраты, если проект предусматривает сокращение государственных доходов или увеличение государственных расходов.';
