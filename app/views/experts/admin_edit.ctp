...
<div id="listcontent">
	...
	<div id="caption" class="red">Editare utilizator</div>
	...
	<div id="Form">
		...
		?>
			<ul>
				...
				<li><?php echo $form->input('Expert.password', array('label'=>'Parola', 'disabled'=>'disabled', 'size'=>'50', 'value'=>''));?></li>
				<li style="padding-left:35%"><input name="PasswordChange" id="PasswordChange" type="checkbox">	modifică parola</li>
