...
<div id="listcontent">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="5" id="green">
        <tr>
            <th width="5">№</th>
            <th><?php echo $paginator->sort('Фамилия и имя пользователя', 'Expert.fullname', array('title' => 'сортировка по Фамилии и имени'));?></th>
            <th width="180"><?php echo $paginator->sort('Login', 'Expert.username', array('title' => 'сортировка по Логину'));?></th>
            <th width="100"><?php echo $paginator->sort('Является администратором', 'Expert.isadmin');?></th>
