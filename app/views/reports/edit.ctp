      ...
      <div class="gri">
          ...
          <?php
            if ($projecttype == 'проект закона') {
              ...
              echo $this->element('report_edit_pointhead', array(
                'letter'=>$pointdigit,
                'headtext'=>'Концепция законопроекта',
          ...
          <?php
            echo $this->element('report_edit_pointhead', array(
              ...
              'headsmalltext'=>'Укажите ваше мнение если концепция законопроекта содержит достаточное обоснование для продвижения проекта законодательного акта.',
          ...
          <?php
            echo $this->element('report_edit_pointhead', array(
              ...
              'headsmalltext'=>'Укажите существование ссылок в концепции законопроекта или тексте проекта на законодательство Сообщества и другие международные стандарты или отсутствие этих ссылок, в случае существования таких актов, установленных экспертом.',
          ...
          <?php
            echo $this->element('report_edit_pointhead', array(
              ...
              'headsmalltext'=>'Определите существование и релевантность финансово-экономического обоснования предписаний проекта в концепции законопроекта.',
              'textareanotrequired'=>true,
          ...
          <table border="0" cellpadding="3" cellspacing="0" width="100%" class="blue">
            <?php
              ...
              echo $this->element('report_edit_radio', array(
								'tdtext'=>'Концепция законопроекта содержит финансово-экономическое обоснование?',
								'radioname'=>'p09radio2',
