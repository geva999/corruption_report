		...
		<td style="border:none;">
			...
			<?php
				if ($this->data['Project']['reporttrasnparenta'] == 1) {
					echo '<br/><p align="justify"><span class="h3">'.$pointdigit.'. Transparenţa decizională</span> '.nl2br($this->data['Report']['p03text1']).'</p>';
					$pointdigit++;
				}
			?>
			...
			<?php
				...
				if ($this->data['Project']['reportrespectaretermen'] == 1) {
					echo '<br/><p align="justify"><span class="h3">'.$pointdigit.'. Respectarea termenului de cooperare cu societatea civilă</span> '.nl2br($this->data['Report']['p06text1']).'</p>';
					$pointdigit++;
				}
			?>
			...
			<?php
				if ($this->data['Project']['reportimpact'] == 1) {
					echo '<br/><p align="justify"><span class="h3">'.$pointdigit.'. Analiza impactului de reglementare a proiectului.</span> '.nl2br($this->data['Report']['p10text1']).'</p>';
					$pointdigit++;
				}
			?>
			...
			<br/><br/>
			<h2>Concluzii</h2>
			<p align="justify"><?php echo nl2br($this->data['Report']['concluzii']);?></p>
