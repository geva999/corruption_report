<table border="1" cellpadding="0" cellspacing="0" align="center" width="100%" class="statistic_table">
	...
	<?php
		...
		//08
		$criterias = array(
			'Пояснительная записка / проект содержит ссылки на международные стандарты',
			'Пояснительная записка / проект НЕ содержит ссылки на международные стандарты'
		);
		echo $this->element('admin_statistic_reports_rows', array(
			'title'=>'Совместимость с международными стандартами',
			'criterias'=>$criterias,
			'statistic'=>$statistic,
