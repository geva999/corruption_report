tinyMCE.init({
  ...
  plugins : 'spellchecker,inlinepopups,paste,searchreplace',
  spellchecker_languages : '+Русский=ru',
  theme_advanced_buttons1 : 'bold,italic,underline,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,|,cut,copy,paste,pastetext,pasteword,|,search,replace,|,code,cleanup,|,spellchecker,|,undo,redo',
