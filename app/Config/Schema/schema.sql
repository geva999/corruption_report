DROP TABLE IF EXISTS `saraptama`.`attachments`;
DROP TABLE IF EXISTS `saraptama`.`authors`;
DROP TABLE IF EXISTS `saraptama`.`celems`;
DROP TABLE IF EXISTS `saraptama`.`experts`;
DROP TABLE IF EXISTS `saraptama`.`pelems`;
DROP TABLE IF EXISTS `saraptama`.`projectexperts`;
DROP TABLE IF EXISTS `saraptama`.`projects`;
DROP TABLE IF EXISTS `saraptama`.`reports`;
DROP TABLE IF EXISTS `saraptama`.`subreports`;
DROP TABLE IF EXISTS `saraptama`.`subreports_celems`;
DROP TABLE IF EXISTS `saraptama`.`subreports_pelems`;
DROP TABLE IF EXISTS `saraptama`.`templates`;


CREATE TABLE `saraptama`.`attachments` (
...
CREATE TABLE `saraptama`.`authors` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `author_group_id` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `created` date DEFAULT NULL,
  `modified` date DEFAULT NULL,  PRIMARY KEY  (`id`),
  KEY `author_group_id` (`author_group_id`))  DEFAULT CHARSET=utf8,
  COLLATE=utf8_general_ci,
  ENGINE=InnoDB;

CREATE TABLE `saraptama`.`celems` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  KEY `celem` (`celem`),
  KEY `number_2` (`number`))  DEFAULT CHARSET=utf8,
  COLLATE=utf8_general_ci,
  ENGINE=InnoDB;

CREATE TABLE `saraptama`.`experts` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `saraptama`.`projectexperts` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `saraptama`.`projects` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `expert_id` int(10) NOT NULL,
  ...
  KEY `reportnumber_2` (`reportnumber`),
  KEY `projectreportstate` (`projectreportstate`),
  KEY `projecttypevizat` (`projecttypevizat`),
  KEY `projectdomain` (`projectdomain`),
  KEY `projectnumber` (`projectnumber`))  DEFAULT CHARSET=utf8,
  COLLATE=utf8_general_ci,
  ENGINE=InnoDB;

CREATE TABLE `saraptama`.`reports` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  `modified` date DEFAULT NULL,  PRIMARY KEY  (`id`),
  KEY `project_id` (`project_id`),
  KEY `reportstate` (`reportstate`))  DEFAULT CHARSET=utf8,
  COLLATE=utf8_general_ci,
  ENGINE=InnoDB;

CREATE TABLE `saraptama`.`subreports` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `saraptama`.`subreports_celems` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `saraptama`.`subreports_pelems` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `subreport_id` int(10) NOT NULL,
...
CREATE TABLE `saraptama`.`templates` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
