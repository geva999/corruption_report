...
<div id="listcontent">
    ...
    <tr>
        <th width="5">№</th>
        <th><?php echo $this->Paginator->sort('Template.name', 'Имя', array('title' => 'сортировка по Имени'));?></th>
        <th><?php echo $this->Paginator->sort('Template.date', 'Дата', array('title' => 'сортировка по Дате'));?></th>
