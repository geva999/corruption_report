...
<div id="listcontent">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="5" id="green">
        <tr>
            <th width="5">№</th>
            <th><?php echo $this->Paginator->sort('Expert.fullname', 'Фамилия и имя пользователя', array('title' => 'сортировка по Фамилии и имени'));?></th>
            <th width="180"><?php echo $this->Paginator->sort('Expert.username', 'Логин', array('title' => 'сортировка по Логину'));?></th>
            <th width="100"><?php echo $this->Paginator->sort('Expert.isadmin', 'Является администратором');?></th>
