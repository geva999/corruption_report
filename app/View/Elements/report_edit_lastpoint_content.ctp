            ...
            <td>
                <div id="<?php echo $rowidtext;?>list">
                    <ul>
                        ...
                        <div align="right">
                            <span style="vertical-align:top"><?php if (($loginedexpertid == $this->request->data['Project']['expert_id'] || $isadmin == 1) && $multipleedit == 1) echo 'Созданный пользователем: '.$experts[$this->request->data['subraport'][$rowid]['Subreport']['expert_id']];?></span>
