...
<div id="listcontent">
    ...
    <tr>
        <th width="5"><?php echo $this->Paginator->sort('Celem.number', '№', array('title' => 'сортировка согласно Номеру'));?></th>
        <th width="200"><?php echo $this->Paginator->sort('Celem.name', 'Имя', array('title' => 'сортировка согласно Имени'));?></th>
        <th width="200"><?php echo $this->Paginator->sort('Celem.celemgroup', 'Группа', array('title' => 'сортировка согласно Группе'));?></th>
        <th><?php echo $this->Paginator->sort('Celem.description', 'Описание', array('title' => 'сортировка согласно Описанию'));?></th>
