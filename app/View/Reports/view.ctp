...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="900">
    ...
    <tr>
        <td>
            <span><?php if ($this->request->data['Report']['reportdatetext'] != '') echo $this->request->data['Report']['reportdatetext'].', ';?><?php if ($this->request->data['Project']['reportnumber'] != '') echo '№. '.$this->request->data['Project']['reportnumber'];?></span>
        ...
        <?php echo nl2br($this->request->data['Report']['p04text1']);?>
            </p>
        ...
        <?php echo nl2br($this->request->data['Report']['p07text1']);?>
            </p>
        ...
        <?php echo nl2br($this->request->data['Report']['p08text1']);?>
            </p>

            <br/>
            <p>
                <span class="h3"><?php echo $pointdigit.'. '; $pointdigit++;?>Финансово-экономическое обоснование.</span>
        <?php echo nl2br($this->request->data['Report']['p09text1']);?>
            </p>
        ...
        <?php echo nl2br($this->request->data['Report']['p15text1']);?>
            ...
            <?php
                ...
                echo nl2br($this->request->data['Report']['simplesubreport']);
            ?>
