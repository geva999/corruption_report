...
<div id="listcontent">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="5" id="orange">
        <tr>
            <th width="5">№</th>
            <th width="50"><?php echo $this->Paginator->sort('Project.reportnumber', 'Номер заключения', array('title' => 'сортировка по Номеру заключения'));?></th>
            <th width="70"><?php echo $this->Paginator->sort('Report.reportdate', 'Дата заключения', array('title' => 'сортировка по Дате заключения'));?></th>
            <th align="left"><?php echo $this->Paginator->sort('Project.name', 'Название заключения', array('title' => 'сортировка по Названию заключения'));?></th>
            <th width="50">Визуализация</th>
            <th width="50">PDF</th>
        </tr>
        <?php
